...
class TestScraper(unittest.TestCase):
    def test_holds(self):
        with codecs.open(
            ...
            result = sfpl.Account.parseHolds(BeautifulSoup(mockup.read(), "lxml"))
    ...
    def test_shelf(self):
        with codecs.open(
            ...
            result = sfpl.Account.parseShelf(BeautifulSoup(mockup.read(), "lxml"))
        ...
        self.assertEqual(
            result[0].subtitle,
            "Examining the Benefits and Risks for Small Business : Hearing Before the Committee on Small Business, United States House of Representatives, One Hundred Thirteenth Congress, Second Session, Hearing Held April 2, 2014",
        )
